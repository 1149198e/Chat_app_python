...
class ChatClientGUI:
    ...
    def initialize_socket(self):
        # Initialize socket with TCP and IPv4
    ...
    def display_name_section(self):
        ...
        self.name_entry.pack(side='left', anchor='e')
    ...
    def display_chat_entry_box(self):
        ...
        self.message_entry = Text(frame, width=60, height=3, font=("Serif", 12))
        self.message_entry.pack(side='left', pady=15)
    ...
    def on_join(self):
        ...
        self.client_socket.send(("joined:" + self.name_entry.get()).encode('utf-8'))
    ...
    def send_chat(self):
        senders_name = self.name_entry.get().strip() + ": "
        data = self.message_entry.get(1.0, 'end').strip()
